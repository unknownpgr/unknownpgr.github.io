    ...
    <ul>
      ...
      <ProjectItem
        ...
        descriptions={[
          ...
          'React / SCSS 등 UI 프레임워크, GitHub Action을 사용한 CI/CD 등 웹 개발을 위한 기초 기술들을 많이 사용해본 프로젝트입니다.'
        ]} />
      <ProjectItem
        ...
        descriptions={[
          ...
          '현장에서 사용하는 장비에서 서버로 데이터 전송, 서버에서 DB에 데이터 저장 및 웹 페이지를 통한 시각화까지 구현한 프로젝트입니다.',
        ]} />
